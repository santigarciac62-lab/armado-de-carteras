...
import { BotonDescargarVisionPdf } from "@/components/armado/BotonDescargarVisionPdf";
import { CARTERAS_MODELO, FECHA_VISION_VIGENTE } from "@/data/modelPortfolios";
...
export default async function Home() {
  ...
  return (
    <div className="flex-1" style={{ background: "var(--bg)" }}>
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-8 pt-6 sm:pt-10 pb-4 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        <div>
          <h1
        ...
        <div className="shrink-0">
          <BotonDescargarVisionPdf carterasModelo={CARTERAS_MODELO} fechaVigente={FECHA_VISION_VIGENTE} />
        </div>
      </div>
